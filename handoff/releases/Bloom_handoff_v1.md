...
## Legal Documents Deployment (Privacy Policy & Terms)

Bloom’s public Privacy Policy and Terms of Service are served directly from the web build output and deployed via the production server (Render).
...
These files **must** be updated whenever legal text changes.

### Deployment Flow
1. Update the HTML files in `client/public/`
2. Run the web build:
   ```bash
   npm run build:web
